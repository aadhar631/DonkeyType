      ...
      <div className="flex item-center">
        <div className="flex items-center gap-[15px]">
          {[15, 30, 60, 120, <HiMiniWrenchScrewdriver />].map((value, index) => (
            <h1
              key={index}
              className={`font-poppins cursor-pointer font-medium hover:text-black dark:hover:text-white ease-in-out duration-500 ${selected === index ? 'text-[#e2b714]' : 'text-[#646669]'
                }`}
